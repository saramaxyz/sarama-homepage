...
const TrustedBy = () => <div className="m-5"></div>;

const YourProducts = () => (
  <div className="flex flex-col items-center">
    <div className="text-6xl font-semibold w-2/5 text-center">
      <span>You</span>&nbsp;<span className="text-red-500">love</span>&nbsp;
      <span>your dog.</span>
    </div>
    <div className="container mt-10 font-normal items-left">
      Our goal is to help dog parents better understand their dogs&apos;
      behavior by creating a system that can decode their barks and body
      language. Our software can be integrated into products to give dog parents
      instant feedback about their dogs&apos; emotions.
    </div>
  </div>
);
  ...
  <div className="flex flex-col items-center container mx-auto">
    ...
    <div className="pt-24 pb-24">
      <div className="flex">
        <div className="w-1/2">
          <div>Icon</div>
          <div className="font-bold text-2xl pb-5 border-b-2 border-blue-800">
      ...
      <div className="flex">
        ...
        <div className="w-1/2">
          ...
          <div className="pt-5">
            We use audio from pet cameras to capture barks along with AI trained
            to find specific bark patterns for individual dogs. This helps dog
            parents determine when their dog is barking and whether it is
      ...
      <div className="flex">
        <div className="w-1/2">
          ...
          <div className="pt-5">
            With better understanding of emotions and bark decoding we create
            predictive models around aggression.
          </div>
        </div>
        <div className="w-1/2">Dog Image</div>
      </div>
...
const Card: React.FC<CardProps> = (props) => (
  <div className="bg-white rounded shadow-2xl flex flex-col items-center w-96 shadow-blue-100">
    <div className="h-72">Dog Image</div>
    <div className="h-72 flex flex-col items-center">
      <div className="font-semibold text-xl pt-10 tracking-wide">
        {props.title}
      </div>
      <div className="grow">
        <div className="pt-8 pl-9 pr-9 tracking-wide">{props.description}</div>
      </div>
      <div className="pb-5">{props.action}</div>
    </div>
  </div>
);
...
const LearnMore = () => (
  <div
    ...
    style={{
      backgroundImage: "url(/white_background.png)",
      maxHeight: "1032px",
    }}
  >
    ...
    <div className="flex space-x-6">
      <Card
        title="How our sensors work"
        description="Scientific papers on sensor tech for dogs."
        action={<Button>Read More</Button>}
      />
      <Card
        title="Can you actually talk to dogs"
        description="Learn how dog communication actually works."
        action={<Button>Read More</Button>}
      />
      <Card
        title="Come decode dogs with us"
        description="Chat with us on our discord server to share lessions of dog parenting."
        action={<Button>Join Our Discord</Button>}
      />
    </div>
  </div>
);
...
const PoweredApp = () => (
  <div
    className="h-screen flex flex-col items-center text-white w-full"
    style={{ backgroundImage: "url(/vr.png)", maxHeight: "976px" }}
  >
    <div className="text-3xl font-semibold text-center p-24">
      AI Powered App <br /> Built on Powerful Sensors
    </div>
    <div className="flex flex-col container mx-auto">
      <div className="flex flex-col w-full text-right">
        <div className="font-semibold">Dog Parents</div>
        <div className="">
          Get peace of mind shopping online knowing
          <br />
          their purchase will continuously monitor
          <br />
          marine ecosystems
        </div>
      </div>
      <div className="flex flex-col w-full text-left">
        ...
        <div className="">
          Sarma provides marketing material to
          <br />
          showcase your values alignment with
          <br />
          dog stress reduction
        </div>
      </div>
    </div>
    <div className="m-16">
  ...
  <div className="flex m-10 p-10 justify-between bg-blue-400 rounded-md">
    <div>
      <span className="text-white-500">
        Use our APIs to add more to your products made for
      </span>
    </div>
    <div>
